 ...
 **************************************************************************
 *                                                                        *
 * This file was modified by Intel High Level Design team to support the  *
 * new directory structure expected by the compiler.                      *
 *                                                                        *
 *************************************************************************/
...
#pragma clang diagnostic pop
  ...
  inline std::string to_string(ac_base_mode base_rep, bool sign_mag = false) const {
    ...
    std::string ret = std::string(r);
    // sometimes .0, sometimes 0
    if(ret == ".0"){
      ret = "0";
    }
    // sometimes 4.0, sometimes 4
    if(ret != "0" && no_fraction){
      ret = ret + ".0";
    }
    return ret;
  }
